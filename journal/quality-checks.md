...
Vient ensuite l'analyse *statique* : examiner le code sans le lancer, comme un correcteur lit une copie. C'est étonnamment puissant - on peut repérer un pointeur potentiellement nul, une valeur de retour ignorée, une conversion hasardeuse, le tout sans jamais exécuter une instruction.
